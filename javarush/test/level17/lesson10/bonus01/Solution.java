...
public class Solution {
    ...
    public static void argsC(String name, String sex, String date) {
    ...
    public static void argsU(String id, String name, String sex, String date) {
        SimpleDateFormat bd = new SimpleDateFormat("dd/MM/yyyy", Locale.ENGLISH);
        Date birthday = new Date();
        try {
            birthday = bd.parse(date);
    ...
    public static void argsI(String id) {
        ...
        System.out.println(a.getName() + " " + sex + " " + bd.format(a.getBirthDay()));
    }
}
