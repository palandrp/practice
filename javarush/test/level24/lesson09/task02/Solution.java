        ...
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                if (!(name1.equals(name2))) return name1.compareTo(name2);
                    ...
                    long date1 = ((Date)stock1.get("date")).getTime() / 1000 * 60 * 60 * 24;
                    long date2 = ((Date)stock2.get("date")).getTime() / 1000 * 60 * 60 * 24;
                    if (date1 != date2) return Long.compare(date2, date1);
                    else {
                        double profits1 = stock1.get("change") != null ? (double)stock1.get("change") : (double)stock1.get("last") - (double)stock1.get("open");
                        double profits2 = stock2.get("change") != null ? (double)stock2.get("change") : (double)stock2.get("last") - (double)stock2.get("open");
                        return Double.compare(profits2, profits1);
                    }
                }
            }
        });
